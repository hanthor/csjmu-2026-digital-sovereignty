...
// ── Helpers ──────────────────────────────────────────────────────────
#let tag(content) = text(size: 10pt, fill: muted, weight: "bold",
  upper(content))

#let slide-title(content) = text(size: 28pt, weight: "bold",
  fill: rgb("#111111"), content)

#let subtitle(content) = text(size: 15pt, fill: muted, content)
...
#block(
  ...
  #text(size: 11pt, fill: midblue, weight: "bold")[
...
#block(
  ...
  #text(size: 11pt, weight: "bold", fill: rgb("#A32D2D"))[INCIDENT A · GERMANY 2024]
  #v(0.25em)
...
#block(
  ...
  #text(size: 11pt, weight: "bold", fill: rgb("#A32D2D"))[INCIDENT B · USA 2025]
  #v(0.25em)
...
#block(width: 100%, inset: (x: 8pt, y: 6pt), fill: subtle, radius: (top: 5pt))[
  #grid(
    ...
    ..("Domain", "Open protocol", "Status", "India position").map(h =>
      text(size: 10pt, weight: "bold", fill: muted, upper(h))
    )
  )
]
  ...
  block(width: 100%, inset: (x: 8pt, y: 7pt), stroke: (bottom: 0.5pt + border))[
    #grid(
      ...
      [
        ...
        #linebreak()
        #text(size: 12pt, fill: muted)[#row.proto-sub]
      ],
      badge-el,
      [
        #text(size: 14pt, weight: "bold")[#row.india]
        #linebreak()
        #text(size: 12pt, fill: muted)[#row.india-sub]
      ],
    )
  ]
}
...
#block(fill: lightblue, radius: 5pt, inset: (x: 12pt, y: 9pt), width: 100%)[
  #text(size: 13pt, fill: rgb("#0C447C"))[India proved open protocols beat proprietary gatekeepers in payments. The same playbook — mandate interoperability, fund open infrastructure — applies directly to messaging and social media.]
]
...
#block(
  ...
  #text(size: 21pt, style: "italic", fill: rgb("#111111"))[
...
#block(
  ...
  #v(2em)
  #align(center)[
    #text(size: 11pt, weight: "bold", fill: muted)[THANK YOU]
    #v(0.6em)
    ...
    #v(2em)
    #text(size: 14pt, fill: muted)[Questions welcome]
  ]
]
